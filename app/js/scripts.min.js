...
$(document).ready(function(){$("#my-menu").mmenu({offCanvas:{position:"right",zposition:"front"}});var i=$("#my-menu").data("mmenu");$("#my-button").click(function(){i.open()}),$(".mm-listview > li > a").hover(function(){$(this).addClass("left-slide")}),$(".mm-listview > li > a").on("blur",function(){$(this).removeClass("left-slide")}),$("#touchSlider").touchSlider()});